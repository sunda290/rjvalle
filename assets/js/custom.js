    ...
    "use strict";
		...
		$(document).ready(function(){
			$('.carousel__element').owlCarousel({
				loop: true,
				margin: 30,
				nav: false, // Desabilite a navegação padrão do Owl Carousel
				dots: false,
				responsive: {
					0: {
						items: 2
			...
			// Vincule as setas personalizadas à navegação do carrossel
			$('.custom-owl-prev').click(function() {
				$('.carousel__element').trigger('prev.owl.carousel');
			});
			$('.custom-owl-next').click(function() {
				$('.carousel__element').trigger('next.owl.carousel');
			});
		});		
